...
import FirstResponderBottomTabNavigation from './FirstResponderBottomTabNavigation';
import { OnLogOut } from './logout';
const baseURL = require("../../../framework/src/config")

const Drawer = createDrawerNavigator();

export default function FirstResponderDrawerNavigation() {
  return (
    <Drawer.Navigator 
      initialRouteName="Home"
		...
		>
			<Drawer.Screen name="Home" component={FirstResponderBottomTabNavigation} />
    </Drawer.Navigator>
  );
}
...
const CustomSidebarMenu = (props: any) => {
  ...
  useEffect(() => {
	...
	const onProfilePress = () => {
		props.navigation.navigate("FirstResponderProfile");
	}
	...
	const onSettingPress = () => {
		props.navigation.navigate("FirstResponderAppSetting")
	}
	const onHelpPress = () => {
	}
	const onDashboardPress = () => {
		props.navigation.navigate("TrackedHours")
	}
    ...
    <SafeAreaView style={{flex: 1, backgroundColor:'#494949'}}>
      ...
      <DrawerContentScrollView {...props}>
				<View style={styles.screenListView}>
					...
					{screenButton(onHistoryPress, alert, "History")}
					{screenButton(onDashboardPress, alert, "Dashboard")}
					{screenButton(onSettingPress, setting, "Settings")}
					{screenButton(onHelpPress, help, "Help")}
					{screenButton(onLogOutPress, help, "Log out")}
				</View>
