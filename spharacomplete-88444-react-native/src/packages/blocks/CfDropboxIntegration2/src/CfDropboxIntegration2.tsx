...
import CfDropboxIntegration2Controller, {
  Props,
  configJSON
} from "./CfDropboxIntegration2Controller";

export default class CfDropboxIntegration2 extends CfDropboxIntegration2Controller {
