...
import EmergencySosGesture2Controller, {
  Props,
  configJSON
} from "./EmergencySosGesture2Controller";

export default class EmergencySosGesture2 extends EmergencySosGesture2Controller {
