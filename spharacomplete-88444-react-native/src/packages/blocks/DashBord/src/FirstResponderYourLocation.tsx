...
import FirstResponderYourLocationController, {
  Props,
  configJSON,
} from "./FirstResponderYourLocationController";
...
// Customizable Area End
export default class FirstResponderYourLocation extends FirstResponderYourLocationController {
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.mapViewStyle}>
          ...
          <View style={styles.topView}>
            <Text style={styles.topViewText}>{configJSON.incidetDetails}</Text>
            <AntDesign
              name="right"
        ...
        <TouchableOpacity
          testID="testingBtn"
          style={styles.getDirectionView}
          onPress={() =>
            this.props.navigation.navigate("FirstResponderLocationDirection")
          }
        >
          <Text style={styles.getDirectionText}>{configJSON.getDirection}</Text>
        </TouchableOpacity>
      </SafeAreaView>
      // Customizable Area End
    );
