...
import FirstResponderLocationDirectionController, {
  Props,
  configJSON,
} from "./FirstResponderLocationDirectionController";
...
// Customizable Area End
export default class FirstResponderLocationDirection extends FirstResponderLocationDirectionController {
  ...
  render() {
    return (
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.startedHeaderView}>
          <View>
            <AntDesign
              name="arrowleft"
              color={COLORS.black}
          ...
          <View style={styles.subView}>
            <View style={styles.subView2}>
              <View style={styles.subView3}>
                ...
                <Text style={styles.multipleSubViewAddress} numberOfLines={2}>
              ...
              <View style={styles.subView6}>
                ...
                <Text style={styles.multipleSubViewAddress2} numberOfLines={2}>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            this.props.navigation.navigate(
              "FirstResponderArrivalCloseIncident",
              {
                locationStatus: "arrival",
              }
            )
          }
          style={[styles.bottomView, styles.distanceView]}
        >
          <Text style={styles.bottomTextView}>
            {this.state.currentAlertData?.distance}K
            <Text style={styles.kmText}>{configJSON.away}</Text>
          </Text>
