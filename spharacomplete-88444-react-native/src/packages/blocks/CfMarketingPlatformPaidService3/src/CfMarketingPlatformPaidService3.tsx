...
import CfMarketingPlatformPaidService3Controller, {
  Props,
  configJSON
} from "./CfMarketingPlatformPaidService3Controller";

export default class CfMarketingPlatformPaidService3 extends CfMarketingPlatformPaidService3Controller {
