...
import CfMultiregionSupportController, {
  Props,
  configJSON
} from "./CfMultiregionSupportController";

export default class CfMultiregionSupport extends CfMultiregionSupportController {
