...
import CfConnectMoreSocialMediaPlatformsAndSmsmmsService2Controller, {
  Props,
  configJSON
} from "./CfConnectMoreSocialMediaPlatformsAndSmsmmsService2Controller";

export default class CfConnectMoreSocialMediaPlatformsAndSmsmmsService2 extends CfConnectMoreSocialMediaPlatformsAndSmsmmsService2Controller {
