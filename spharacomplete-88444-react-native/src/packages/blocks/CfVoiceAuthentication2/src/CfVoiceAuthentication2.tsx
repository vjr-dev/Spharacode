...
import CfVoiceAuthentication2Controller, {
  Props,
  configJSON
} from "./CfVoiceAuthentication2Controller";

export default class CfVoiceAuthentication2 extends CfVoiceAuthentication2Controller {
