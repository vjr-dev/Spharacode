...
import CfGoogleDriveIntegration2Controller, {
  Props,
  configJSON
} from "./CfGoogleDriveIntegration2Controller";

export default class CfGoogleDriveIntegration2 extends CfGoogleDriveIntegration2Controller {
