...
export const COLORS = {
  ...
  lightorange: 'rgba(178,136,108,1)',
  lightyellow: 'rgba(207,185,155,1)',
  backgroundGray: '#404040',
  darkorange: "rgba(255,138,73,1)",
  lightorangeback: "#f1ebe8",
  headerbackground: "#454545",
  Viewback: "#515151",
  lightwhite: "#cdcdcd",
  ultralightwhite: "#a1a1a1",
  orangelight: "rgba(255,211,154,1)",
  ultradarkorange: "#fa6738",
  switchDarkGray:"#3a3a3a",
};